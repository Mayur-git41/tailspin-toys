...
The shared header includes a keyboard-accessible **High contrast** toggle. The preference is stored in `localStorage` and restored automatically on later page loads. The default dark theme remains unchanged when high-contrast mode is disabled.
